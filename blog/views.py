...
def show_all_posts(request):
    ...
    return render(
        request=request,
        context={"object_list": my_posts, "object_list_2": other_posts, "page_title": "Show all posts"},
...
def create_post(request):
    ...
    return render(request, "blog/post_form.html", {"form": form_instance, "page_title": "Create a new post"})
...
def edit_post(request, pk):
    ...
    if request.method == "POST":
        ...
        return render(
            request,
            context={"form": form_instance, "page_title": f"Edit post #{post_instance.pk}"},
...
class CreateCategory(PermissionRequiredMixin, CreateView):
    ...
    extra_context = {"page_title": "Create a category"}
